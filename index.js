...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    const displayNames = []
   zooAnimals.forEach((animal) => {displayNames.push("name: " + animal.animal_name + 
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const lowpops = zooAnimals.filter((arr)=>{ return arr.population <= 5
    })
    return lowpops
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    const pop = zooAnimals.reduce((accu, popu) => accu + popu.population, 0)
    return pop
  }
